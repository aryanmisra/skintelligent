...
model_sec_a = keras.models.load_model('saves/model_A_10.h5', compile=False)

model_sec_c = keras.models.load_model('saves/model_C_10.h5', compile=False)

model_sec_p = keras.models.load_model('saves/model_P_10.h5', compile=False)

model_sec_u = keras.models.load_model('saves/model_U_10.h5', compile=False)

model_sec_w = keras.models.load_model('saves/model_W_10.h5', compile=False)
